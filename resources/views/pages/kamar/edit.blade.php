...
<div class="page-content">
    <section class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama-kamar-column" class="form-control"
                                            placeholder="Nama Kamar" name="nama_kamar" value="{{$data->nama_kamar}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <table id="exampleServerSide"
                                class="table table-striped table-bordered table-hover text-center users-table"
                                style="width: 100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
        ...
        <!--Basic Modal -->
        <div class="modal fade text-left w-500" id="default" tabindex="-1" role="dialog"

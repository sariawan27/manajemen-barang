                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="no-identity-column" class="form-control"
                                            placeholder="Nomor Identitas" name="no_identity" value="{{$data->no_identitas}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="no-telp-column" class="form-control"
                                            placeholder="No Telp" name="no_telp" value="{{$data->no_telp}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nim-column" class="form-control"
                                            placeholder="NIM" name="nim" value="{{$data->nim}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="angkatan-column">Angkatan</label>
                                        <input type="text" id="angkatan-column" class="form-control"
                                            placeholder="Angkatan" name="angkatan" value="{{$data->angkatan}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">

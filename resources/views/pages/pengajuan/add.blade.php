                                        ...
                                        <div class="col-md-12 col-12" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="no-column" class="form-control"
                                                    placeholder="No." name="no" value="{{session()->get('users')['id']}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nama-column" class="form-control"
                                                    placeholder="Nama Taruni" name="nama" value="{{session()->get('users')['nama']}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="no-telp-column" class="form-control"
                                                    placeholder="No. Telp" name="no_telp" value="{{session()->get('users')['no_telp']}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="kamar-column" class="form-control"
                                                    placeholder="Kamar" name="nama_kamar" value="{{session()->get('users')['nama_kamar']}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="kd-pengajuan-column" class="form-control"
                                                    placeholder="Kode Pengajuan" name="kd_pengajuan" value="{{$kdPengajuan}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="barang-dipilih-column" class="form-control"
                                                    placeholder="Kode Pengajuan" name="barang_dipilih">
                                            </div>
                                        </div>
                                    </div>
                                </div>

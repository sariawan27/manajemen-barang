        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 d-flex justify-content-center"><h2>{{strtoupper($dataPengajuan->status)}}</h2></div>
                        </div>
                        ...
                        <form id="form" class="form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-12" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="no-column" class="form-control"
                                                    placeholder="No." name="no" value="{{$dataPengajuan->user_id}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nama-column" class="form-control"
                                                    placeholder="Nama Taruni" name="nama" value="{{$dataPengajuan->nama}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                <label for="no-telp-column">No. Telp</label>
                                                <input type="text" id="no-telp-column" class="form-control"
                                                    placeholder="No. Telp" name="no_telp" value="{{$dataPengajuan->no_telp}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="kamar-column" class="form-control"
                                                    placeholder="Kamar" name="nama_kamar" value="{{$dataPengajuan->nama_kamar}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                <label for="kd-pengajuan-column">Kode Pengajuan</label>
                                                <input type="text" id="kd-pengajuan-column" class="form-control"
                                                    placeholder="Kode Pengajuan" name="kd_pengajuan" value="{{$dataPengajuan->kd_pengajuan}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12" style="display: none;">
                                            <div class="form-group">
                                                <label for="barang-dipilih-column">Data Barang yang Dipilih</label>
                                                <input type="text" id="barang-dipilih-column" class="form-control"
                                                    placeholder="Kode Pengajuan" name="barang_dipilih" value="{{json_encode($detailPengajuan)}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12 col-12 d-flex justify-content-center"><h3>Barang yang Diajukan</h3></div>
                            </div>
                            <div class="row mt-1">
                                <div class="col-md-12 col-12">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12 col-12 d-flex justify-content-center"><h3>Ulasan</h3></div>
                        </div>
                        <div class="row mt-1">
                            <div class="col-md-12 col-12">
                                <table class="table table-borderd">
                        ...
                        <form id="form_ulasan" class="form">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <textarea type="text" id="nama-column" class="form-control"
                                            placeholder="Ulasan" name="ulasan"> </textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
